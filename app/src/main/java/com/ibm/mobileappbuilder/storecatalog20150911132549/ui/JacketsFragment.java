 ...
 */
public class JacketsFragment extends ListGridFragment<ProductsDSItem>  {
    ...
    */
    ...
    protected void bindView(ProductsDSItem item, View view, int position) {
        ...
        if (item.wadrobe != null){
            title.setText(item.wadrobe);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.filter){
            Intent intent = new Intent(getActivity(), JacketsFilterActivity.class);
