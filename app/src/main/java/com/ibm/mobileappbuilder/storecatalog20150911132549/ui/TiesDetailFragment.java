...
public class TiesDetailFragment extends ibmmobileappbuilder.ui.DetailFragment<ProductsDSItem> implements ShareBehavior.ShareListener  {

    private Datasource<ProductsDSItem> datasource;
    public static TiesDetailFragment newInstance(Bundle args){
        TiesDetailFragment fr = new TiesDetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public TiesDetailFragment(){
        super();
    }
    ...
    protected int getLayout() {
        return R.layout.tiesdetail_detail;
    }
    ...
    protected void onShow(ProductsDSItem item) {
        ...
        getActivity().setTitle(item.wadrobe);
    }
    @Override
    public void onShare() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, item.wadrobe);
