...
/**
 * JacketsFilterActivity filter activity
 */
public class JacketsFilterActivity extends FilterActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set title
        setTitle(R.string.jacketsFilterActivity);
    }
    ...
    ArrayList<String> rating_values;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            return inflater.inflate(R.layout.jackets_filter, container, false);
        }
