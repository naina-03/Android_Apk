...
/**
 * ShirtsFilterActivity filter activity
 */
public class ShirtsFilterActivity extends FilterActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set title
        setTitle(R.string.shirtsFilterActivity);
    }
    ...
    ArrayList<String> rating_values;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            return inflater.inflate(R.layout.shirts_filter, container, false);
        }
